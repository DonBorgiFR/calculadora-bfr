        ...
        >
          ...
          <div className="px-6 sm:px-10 pb-10">
            ...
            <div className="text-center sm:text-left mb-10">
              ...
              >
                Controller Financiero & Desarrollador Full-Stack (Odoo/React/AI)
              </motion.p>
              <motion.p 
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
                className="mt-4 text-slate-400 max-w-2xl leading-relaxed text-sm sm:text-base"
              >
                Especialista en hibridar mundos: Lógica financiera rigurosa y experiencias visuales (Frontend) excepcionales. Apasionado por la Inteligencia Artificial y la arquitectura de software sostenible. 
              </motion.p>
            </div>
              ...
              >
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    <TechBadge label="React 19 / TS" color="blue" />
                    <TechBadge label="Tailwind CSS" color="indigo" />
                    <TechBadge label="Node.js / API" color="green" />
                    <TechBadge label="Odoo ERP" color="purple" />
                    <TechBadge label="Finanzas Corporativas" color="yellow" />
                    <TechBadge label="AI & LLLM Integrations" color="red" />
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
                  ...
                  <ul className="space-y-4">
                    <HistoryItem 
                      title="Calculadora BFR (Este Proyecto)" 
                      desc="Motor impositivo cíclico, proyecciones indexadas de IPC a 5 años, PWA Native y UI Premium Glassmorphism."
                    />
                    <HistoryItem 
                      title="Integración AI & Finanzas" 
                      desc="Modelado de arquitecturas para automatización financiera y proyecciones de rentabilidad en bienes raíces."
                    />
                  </ul>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-gradient-to-br from-indigo-900/40 to-purple-900/20 border border-indigo-500/20 rounded-xl p-6 relative overflow-hidden">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed relative z-10">
                    La mayoría de desarrolladores no entienden balances; la mayoría de financieros no pueden programar un sistema escalable. <br/><br/>
                    <span className="text-white font-semibold">Yo traduzco la complejidad contable en código limpio y experiencias de usuario atractivas.</span>
                  </p>
                </div>

                 <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
                    <p className="text-slate-400 text-sm mb-4">"Has encontrado el Easter Egg en el código."</p>
                    <a href="mailto:tuemail@ejemplo.com" className="inline-block w-full text-center px-4 py-2.5 bg-slate-700 hover:bg-slate-600 text-white rounded-lg text-sm font-medium transition-colors shadow-lg">
                      Contactar ahora
                    </a>
                </div>
              </motion.div>
...
function TechBadge({ label, color }: { label: string, color: 'blue'|'indigo'|'green'|'purple'|'yellow'|'red' }) {
  ...
  return (
    <div className={`px-3 py-2 rounded-lg border text-xs font-medium text-center ${colors[color]}`}>
      {label}
    </div>
  )
}
